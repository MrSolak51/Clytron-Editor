...
class new_window:
    def __init__(self, path):
        ...
        self.edit_window.title("CLYTRONEDIT")
...
main_window.title("CLYTRONEDIT")
logo = PhotoImage(file='logo.png')
main_window.iconphoto(True, logo)

welcome_label = Label(main_window, image=logo, text="Welcome To ClytronEditor", bg="black", fg="#F5F5DC", compound="top", font=('Arial', 30))
welcome_label.pack()
...
exit_button = Button(main_window, text="EXIT", bg="red", fg="#F5F5DC", command=main_window.destroy, font=('Arial', 30), width=17)
exit_button.pack()
